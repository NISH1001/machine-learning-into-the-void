...
Or you can use already available activation function like [sigmoid]. This activation gives you the output in the range 0 to 1.
If this output is high around 1, it means perceptron has fired.

## Output
Normally, perceptron outputs boolean value : **0/1** or **False/True**.
...
Here, we have only used two input features **x1, x2**.
